<div class="userConversations index">
	<h2><?php echo __('User Conversations'); ?></h2>
	...
	<tr>
		<td><?php echo h($userConversation['UserConversation']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($userConversation['UserConversation']['is_deleted']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userConversation['UserConversation']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userConversation['UserConversation']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userConversation['UserConversation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $userConversation['UserConversation']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
